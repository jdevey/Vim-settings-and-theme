" To get this color scheme installed for vim, add it to the vim80/colors
" directory, then comment out the line in desert.vim that says:
" hi Normal	guifg=White guibg=black
" You also need to go into the vimrc and make the colorscheme line say:
" colorscheme perun
...
" Cursor line
highlight CursorLine guibg=#707070
" Error
...
let g:terminal_color_background = "#050505"
